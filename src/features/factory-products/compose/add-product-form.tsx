  ...
  return (
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Например, Кроссовки SuperFlex"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Мужская обувь">
                          Мужская обувь
                        </SelectItem>
                        <SelectItem value="Женская обувь">
                          Женская обувь
                        </SelectItem>
                        <SelectItem value="Женская обувь">
                          Детская обувь
                        </SelectItem>
                        <SelectItem value="Аксессуары и уход">
                          Аксессуары и уход
                        </SelectItem>
                      </SelectContent>
                    </Select>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Например, Текстиль, Резина, Кожа"
                        {...field}
                        className="w-full"
                      />
                    </FormControl>
        ...
        {/* --- Футер с кнопками --- */}
        <div className="flex items-center justify-between rounded-b-lg border-t p-6">
