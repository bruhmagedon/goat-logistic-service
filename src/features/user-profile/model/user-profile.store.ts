...
const mockPurchaseCategories: PurchaseCategoryDataPoint[] = [
  { category: "Муж. обувь", volume: 220000, fill: "var(--color-male-shoes)" },
  { category: "Жен. обувь", volume: 150000, fill: "var(--color-female-shoes)" },
  { category: "Аксессуары", volume: 80000, fill: "var(--color-accessories)" },
];
